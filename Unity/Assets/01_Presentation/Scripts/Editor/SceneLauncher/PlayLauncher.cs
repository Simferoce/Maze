...
namespace Game.Presentation
{
    ...
    {
        public const string PLAYER_DEFINITION_KEY = "SceneLauncher_PlayerDefinition";
        ...
        public override void Launch()
        {
            ...
            playManager.Play(GetObject<WorldPresentationDefinition>(WORLD_DEFINITION_KEY).Id, GetObject<CharacterPresentationDefinition>(PLAYER_CHARACTER_DEFINITION_KEY).Id, GetObject<PlayerPresentationDefinition>(PLAYER_DEFINITION_KEY).Id, GetInt(SEED_KEY), GetBool(RECORD_KEY));
        }

        public override void Load()
        {
            SetObject<PlayerPresentationDefinition>(PLAYER_DEFINITION_KEY, LoadObject<PlayerPresentationDefinition>(PLAYER_DEFINITION_KEY));
